	 ...
	 <div class="container">
		 ...
		 <div class="col-md-9 product-model-sec">
					...
					@foreach ($muebles as $mueble)
					 <a href="/products/{{ $mueble->id_mueble }}"><div class="product-grid love-grid">
						<div class="more-product"><span> </span></div>						
						<div class="product-img b-link-stripe b-animate-go  thickbox">
							<img src="{{ $mueble->furnishing_img }}" class="img-responsive" alt=""/>
							<div class="b-wrapper">
						...
						<div class="product-info simpleCart_shelfItem">
							<div class="product-info-cust">
								<h4>{{ $mueble->nombre_mueble }}</h4>
								<p>ID: {{ $mueble->id_mueble }}</p>
								<span class="item_price">${{ $mueble ->precio_mueble }}</span>

									
									<input type="submit" class="item_add items" value="Agregar a Carrito" onclick="event.preventDefault();
                                             document.getElementById('addToCart-form{{ $mueble->id_mueble }}').submit();">
									<form id="addToCart-form{{ $mueble->id_mueble }}" action="{{ route('add-to-cart', ['id' => $mueble->id_mueble]) }}" method="GET" style="display: none;">
