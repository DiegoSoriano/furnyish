		 ...
		 <!-- start content -->	
			<div class="col-md-9 det">
						 ...
						 <ul id="etalage">
							<li class="etalage_thumb thumb_1">
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="{{ URL::asset('images/ss1.jpg') }}" class="img-responsive" />
									<img class="etalage_source_image" src="{{ URL::asset('images/ss1.jpg') }}" class="img-responsive" title="" />
								</a>
							</li>
							<li class="etalage_thumb thumb_2">
								<img class="etalage_thumb_image" src="{{ URL::asset('images/ss2.jpg') }}" class="img-responsive" />
								<img class="etalage_source_image" src="{{ URL::asset('images/ss2.jpg') }}" class="img-responsive" title="" />
							</li>							
						    <li class="etalage_thumb thumb_3">
								<img class="etalage_thumb_image" src="{{ URL::asset('images/ss4.jpg') }}" class="img-responsive"  />
								<img class="etalage_source_image" src="{{ URL::asset('images/ss4.jpg') }}"class="img-responsive"  />
							</li>
						 </ul>
				  ...
				  <div class="single-right">
					 ...
					 <div class="id"><h4>ID: {{ $mueble -> id_mueble }}</h4></div>
					  ...
					  <div class="cost">
						 ...
						 <div class="check">
							 <p><span class="glyphicon glyphicon-map-marker" aria-hidden="true"></span>Ingresa tu código postal para verificar disponibilidad de envíos</p>
					  ...
					  <div class="item-list">
						 <ul>
							 <li>Material: {{ $mueble -> material_mueble }}</li>
							 <li>Color: {{ $mueble -> color_mueble }}</li>
							 <li>Estilo: {{ $mueble -> estilo_mueble }}</li>
							 <li>Marca: {{ $mueble -> marca_mueble }}</li>
							 <li><a href="#">Clic aquí para mas información</a></li>
						 </ul>
					  </div>
					  <div class="single-bottom1">
						<h6>Detalles</h6>
						<p class="prod-desc">{{ $mueble -> detalles_mueble }}</p>
					 </div>					 
				  </div>
				  <div class="clearfix"></div>
